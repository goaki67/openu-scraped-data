...
def extract_course_metadata():
    ...
    try:
        with open('data/ast_prerequisites.json', 'r', encoding='utf-8') as f:
            ast_data = json.load(f)
    except Exception as e:
        print("Could not load data/ast_prerequisites.json:", e)
        ast_data = {}

    print("Parsing raw HTML for metadata...")
    courses_metadata = {}
    
    with open('data/scraped_course_pages.jsonl', 'r', encoding='windows-1255') as f:
        for line in f:
            try:
    ...
    print("Writing to data/enriched_courses.json...")
    with open('data/enriched_courses.json', 'w', encoding='utf-8') as f:
